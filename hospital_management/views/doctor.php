...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Add, edit, search and remove patients in the system</p>
        </div>
    </div>
    ...
    <div class="card form-card">
        ...
        <form method="POST"
            ...
            <div class="field-row">
                ...
                <div class="field">
                    <label for="author">Diagnosis</label>
            ...
            <div class="field-row">
                <div class="field">
                    <label for="quantity">Ward No</label>
                ...
                <tbody id="tableBody">
                    ...
                    <?php else: ?>
                        <?php foreach ($patients as $i => $patient): ?>
                            <tr>
                                <td><?= $i + 1 ?></td>
                                <td><?= htmlspecialchars($patient['title']) ?></td>
                                <td><?= htmlspecialchars($patient['author']) ?></td>
                                <td><?= htmlspecialchars($patient['quantity']) ?></td>
