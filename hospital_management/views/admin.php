...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Register, edit, search and remove doctor accounts</p>
        </div>
    </div>

    <?php if (isset($_GET['msg'])): ?>
        <?php $messages = ['added' => 'Doctor added successfully.',
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit Doctor (#' . intval($editing['id']) . ')' : '+ Add New Doctor' ?>
        </h3>
        <form method="POST"
    ...
    <div class="card">
        <div class="card-toolbar">
            ...
            <span class="badge" id="resultCount"><?= count($doctors) ?> total</span>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    <?php if (empty($doctors)): ?>
                        <tr><td colspan="5" class="empty">No doctors yet.</td></tr>
                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn-sm btn-edit"
                                       href="index.php?page=admin&action=edit&id=<?= $doc['id'] ?>">Edit</a>
                                    <a class="btn-sm btn-delete"
                                       href="index.php?page=admin&action=delete&id=<?= $doc['id'] ?>"
...
(function () {
    ...
    input.addEventListener('input', function () {
        ...
        timer = setTimeout(function () {
            fetch('index.php?page=ajax&type=doctor&q=' + encodeURIComponent(input.value.trim()),
